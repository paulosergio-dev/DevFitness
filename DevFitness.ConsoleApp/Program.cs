...
namespace DevFitness.ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string nomeCompleto = "Paulo Sérgio";
            ...
            var comida = new Comida("Sanduba", 600, 0.5M);
        ...
        {
            Console.WriteLine("---= Seja vem vindo (a) ao DevFitness. =---");
        ...
        public static void Cadastrar (List<Refeicao> refeicoes)
        {
            ...
            if (int.TryParse(calorias, out int caloriasInt))
            {
                ...
                Console.WriteLine("Refeicao adicionada com sucesso.");
            }
            else 
            {
                Console.WriteLine("Valor de calorias invpalido.");
            }
        }
